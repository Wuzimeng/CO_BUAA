...
#endif
static const char *ng0 = "D:/CO/P6/CPU_2/STOP_CONTROL.v";
static int ng1[] = {1, 0};
static int ng2[] = {0, 0};
...
LAB613:    memcpy(t35, t6, 8);

LAB614:    memset(t50, 0, 8);
    t51 = (t35 + 4);
    t58 = *((unsigned int *)t51);
    t59 = (~(t58));
    t60 = *((unsigned int *)t35);
...
LAB627:    memcpy(t74, t50, 8);

LAB628:    t115 = (t0 + 5768);
    xsi_vlogvar_assign_value(t115, t74, 0, 0, 1);
...
LAB637:    *((unsigned int *)t35) = 1;

LAB639:    memset(t19, 0, 8);
    t18 = (t35 + 4);
...
LAB647:    if (*((unsigned int *)t21) > 0)
        goto LAB648;

LAB649:    if (*((unsigned int *)t19) > 0)
        goto LAB650;

LAB651:    memcpy(t6, t36, 8);
...
LAB654:    *((unsigned int *)t35) = 1;

LAB656:    memset(t19, 0, 8);
    t18 = (t35 + 4);
    t26 = *((unsigned int *)t18);
    t27 = (~(t26));
    t28 = *((unsigned int *)t35);
...
LAB666:    if (*((unsigned int *)t19) > 0)
        goto LAB667;

LAB668:    memcpy(t6, t36, 8);
...
LAB671:    *((unsigned int *)t35) = 1;

LAB673:    memset(t19, 0, 8);
    t18 = (t35 + 4);
    t26 = *((unsigned int *)t18);
    t27 = (~(t26));
    t28 = *((unsigned int *)t35);
...
LAB683:    if (*((unsigned int *)t19) > 0)
        goto LAB684;

LAB685:    memcpy(t6, t36, 8);
...
LAB616:    if (*((unsigned int *)t21) != 0)
        goto LAB617;

LAB618:    t28 = *((unsigned int *)t6);
    t29 = *((unsigned int *)t19);
    t30 = (t28 | t29);
    *((unsigned int *)t35) = t30;
    t36 = (t6 + 4);
...
LAB630:    if (*((unsigned int *)t79) != 0)
        goto LAB631;

LAB632:    t77 = *((unsigned int *)t50);
    t81 = *((unsigned int *)t66);
    t82 = (t77 | t81);
    *((unsigned int *)t74) = t82;
    t88 = (t50 + 4);
...
LAB648:    xsi_vlog_unsigned_bit_combine(t6, 32, t34, 32, t36, 32);
    goto LAB652;

LAB650:    memcpy(t6, t34, 8);
    goto LAB652;
...
LAB665:    xsi_vlog_unsigned_bit_combine(t6, 32, t34, 32, t36, 32);
    goto LAB669;

LAB667:    memcpy(t6, t34, 8);
    goto LAB669;
...
LAB682:    xsi_vlog_unsigned_bit_combine(t6, 32, t34, 32, t36, 32);
    goto LAB686;

LAB684:    memcpy(t6, t34, 8);
    goto LAB686;

}


extern void work_m_00000000001609703119_1486854853_init()
{
	static char *pe[] = {(void *)Initial_41_0,(void *)Always_63_1};
	xsi_register_didat("work_m_00000000001609703119_1486854853", "isim/CPU_tb_isim_beh.exe.sim/work/m_00000000001609703119_1486854853.didat");
