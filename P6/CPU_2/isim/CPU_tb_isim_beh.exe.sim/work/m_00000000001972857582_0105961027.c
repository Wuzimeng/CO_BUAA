...
#endif
static const char *ng0 = "D:/CO/P6/CPU_2/E.v";
static int ng1[] = {0, 0};
static int ng2[] = {5, 0};
static int ng3[] = {10, 0};
...
LAB35:    xsi_set_current_line(117, ng0);
    ...
    *((unsigned int *)t16) = t8;
    ...
    t21 = (t10 & 1);
    *((unsigned int *)t4) = t21;
    xsi_vlogtype_concat(t14, 33, 33, 2U, t16, 1, t5, 32);
    t17 = (t0 + 1688U);
    t18 = *((char **)t17);
    t17 = (t0 + 1688U);
    t20 = *((char **)t17);
    ...
    *((unsigned int *)t17) = t35;
    xsi_vlogtype_concat(t27, 33, 33, 2U, t19, 1, t18, 32);
    xsi_vlog_unsigned_divide(t41, 33, t14, 33, t27, 33);
    t29 = (t0 + 3528);
    xsi_vlogvar_assign_value(t29, t41, 0, 0, 33);
    ...
    *((unsigned int *)t16) = t8;
    ...
    t21 = (t10 & 1);
    *((unsigned int *)t2) = t21;
    xsi_vlogtype_concat(t14, 33, 33, 2U, t16, 1, t4, 32);
    t15 = (t0 + 1688U);
    t17 = *((char **)t15);
    t15 = (t0 + 1688U);
    t18 = *((char **)t15);
    ...
    *((unsigned int *)t15) = t35;
    xsi_vlogtype_concat(t27, 33, 33, 2U, t19, 1, t17, 32);
    xsi_vlog_unsigned_mod(t41, 33, t14, 33, t27, 33);
    t28 = (t0 + 3688);
    xsi_vlogvar_assign_value(t28, t41, 0, 0, 33);
...
extern void work_m_00000000001972857582_0105961027_init()
{
	static char *pe[] = {(void *)Initial_77_0,(void *)Always_87_1};
	xsi_register_didat("work_m_00000000001972857582_0105961027", "isim/CPU_tb_isim_beh.exe.sim/work/m_00000000001972857582_0105961027.didat");
