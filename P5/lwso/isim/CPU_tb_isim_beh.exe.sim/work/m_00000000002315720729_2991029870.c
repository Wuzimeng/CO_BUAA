...
#endif
static const char *ng0 = "D:/CO/P5/lwso/DECODE.v";
static int ng1[] = {0, 0};
...
LAB510:    if (*((unsigned int *)t86) > 0)
        goto LAB511;

LAB512:    if (*((unsigned int *)t5) > 0)
        goto LAB513;

LAB514:    memcpy(t4, t80, 8);
...
LAB509:    t95 = (t0 + 4168);
    ...
    t128 = *((char **)t123);
    memset(t134, 0, 8);
    xsi_vlog_unsigned_add(t134, 1, t118, 1, t128, 1);
    t129 = (t0 + 4488);
    t131 = (t129 + 56U);
    t132 = *((char **)t131);
    memset(t135, 0, 8);
    xsi_vlog_unsigned_add(t135, 1, t134, 1, t132, 1);
    t133 = (t0 + 4648);
    t136 = (t133 + 56U);
    t137 = *((char **)t136);
    memset(t138, 0, 8);
...
LAB523:    if (*((unsigned int *)t141) > 0)
        goto LAB524;

LAB525:    if (*((unsigned int *)t130) > 0)
        goto LAB526;

LAB527:    memcpy(t80, t143, 8);

LAB528:    goto LAB510;

LAB511:    xsi_vlog_unsigned_bit_combine(t4, 32, t94, 32, t80, 32);
    goto LAB515;

LAB513:    memcpy(t4, t94, 8);
    goto LAB515;

LAB516:    *((unsigned int *)t130) = 1;
    goto LAB519;
...
LAB520:    t142 = ((char*)((ng14)));
    goto LAB521;

LAB522:    t143 = ((char*)((ng1)));
    goto LAB523;

LAB524:    xsi_vlog_unsigned_bit_combine(t80, 32, t142, 32, t143, 32);
    goto LAB528;

LAB526:    memcpy(t80, t142, 8);
    goto LAB528;
...
{
	static char *pe[] = {(void *)Initial_62_0,(void *)Always_78_1};
