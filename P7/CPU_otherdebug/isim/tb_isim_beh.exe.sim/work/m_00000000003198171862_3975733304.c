...
#endif
static const char *ng0 = "D:/CO/P7/CPU_otherdebug/CP0.v";
static int ng1[] = {12, 0};
static int ng2[] = {13, 0};
static int ng3[] = {0, 0};
static int ng4[] = {4, 0};
...
LAB86:    if (*((unsigned int *)t53) > 0)
        goto LAB87;

LAB88:    memcpy(t52, t65, 8);

LAB89:    goto LAB71;

LAB72:    xsi_vlog_unsigned_bit_combine(t13, 32, t11, 32, t52, 32);
    goto LAB76;

LAB74:    memcpy(t13, t11, 8);
    goto LAB76;

LAB77:    *((unsigned int *)t53) = 1;
    goto LAB80;
...
LAB85:    xsi_vlog_unsigned_bit_combine(t52, 32, t18, 32, t65, 32);
    goto LAB89;

LAB87:    memcpy(t52, t18, 8);
    goto LAB89;

LAB90:    t51 = *((unsigned int *)t71);
...
LAB124:    xsi_set_current_line(145, ng0);
    ...
    *((unsigned int *)t25) = (t110 & 1073741823U);
    ...
    t68 = *((char **)t67);
    t69 = ((char*)((ng5)));
    xsi_vlog_generic_convert_array_indices(t65, t70, t60, t68, 2, 1, t69, 32, 1);
    t72 = (t65 + 4);
...
LAB125:    t113 = *((unsigned int *)t65);
    t114 = *((unsigned int *)t70);
    t87 = (t113 - t114);
    t88 = (t87 + 1);
    xsi_vlogvar_assign_value(t56, t53, 0, *((unsigned int *)t70), t88);
    goto LAB126;
...
LAB130:    xsi_set_current_line(149, ng0);
    ...
    *((unsigned int *)t14) = (t33 & 1073741823U);
    t34 = *((unsigned int *)t5);
    *((unsigned int *)t5) = (t34 & 1073741823U);
    ...
    t21 = *((char **)t20);
    t22 = ((char*)((ng5)));
    xsi_vlog_generic_convert_array_indices(t52, t53, t18, t21, 2, 1, t22, 32, 1);
    t25 = (t52 + 4);
...
LAB131:    t37 = *((unsigned int *)t52);
    t38 = *((unsigned int *)t53);
    t31 = (t37 - t38);
    t32 = (t31 + 1);
    xsi_vlogvar_assign_value(t15, t13, 0, *((unsigned int *)t53), t32);
    goto LAB132;
...
extern void work_m_00000000003198171862_3975733304_init()
{
	...
	xsi_register_didat("work_m_00000000003198171862_3975733304", "isim/tb_isim_beh.exe.sim/work/m_00000000003198171862_3975733304.didat");
