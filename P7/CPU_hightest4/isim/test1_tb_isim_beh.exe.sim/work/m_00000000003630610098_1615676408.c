...
#endif
static const char *ng0 = "D:/CO/P7/CPU_hightest4/MUX.v";
...
LAB21:    if (*((unsigned int *)t24) < *((unsigned int *)t16))
        goto LAB20;
...
LAB47:    t98 = (t0 + 1688U);
    ...
    *((unsigned int *)t106) = (t113 & 268435455U);
    t114 = *((unsigned int *)t98);
    *((unsigned int *)t98) = (t114 & 268435455U);
    t115 = ((char*)((ng3)));
    memset(t116, 0, 8);
    t117 = (t106 + 4);
    t118 = (t115 + 4);
...
LAB63:    memcpy(t179, t132, 8);

LAB64:    memset(t211, 0, 8);
    t212 = (t179 + 4);
...
LAB81:    memcpy(t338, t211, 8);

LAB82:    memset(t105, 0, 8);
    t366 = (t338 + 4);
...
LAB115:    t373 = (t105 + 4);
    t374 = *((unsigned int *)t105);
    t375 = *((unsigned int *)t373);
    t376 = (t374 || t375);
    if (t376 > 0)
        goto LAB116;

LAB117:    t379 = *((unsigned int *)t105);
    t380 = (~(t379));
...
LAB119:    if (*((unsigned int *)t373) > 0)
        goto LAB120;

LAB121:    if (*((unsigned int *)t105) > 0)
        goto LAB122;

LAB123:    memcpy(t104, t377, 8);

LAB124:    goto LAB48;

LAB49:    xsi_vlog_unsigned_bit_combine(t22, 32, t99, 32, t104, 32);
    goto LAB53;

LAB51:    memcpy(t22, t99, 8);
    goto LAB53;
...
LAB80:    t225 = (t0 + 1688U);
    ...
    *((unsigned int *)t225) = (t233 & 268435455U);
    t234 = ((char*)((ng5)));
    memset(t235, 0, 8);
    t236 = (t224 + 4);
    t237 = (t234 + 4);
...
LAB84:    *((unsigned int *)t235) = 1;

LAB86:    memset(t251, 0, 8);
    t252 = (t235 + 4);
...
LAB102:    t310 = *((unsigned int *)t298);
    t311 = *((unsigned int *)t304);
    *((unsigned int *)t298) = (t310 | t311);
    t312 = (t251 + 4);
    t313 = (t290 + 4);
    t314 = *((unsigned int *)t251);
    t315 = (~(t314));
...
LAB116:    t377 = (t0 + 1208U);
    t378 = *((char **)t377);
    goto LAB117;

LAB118:    t377 = ((char*)((ng6)));
    goto LAB119;

LAB120:    xsi_vlog_unsigned_bit_combine(t104, 32, t378, 32, t377, 32);
    goto LAB124;

LAB122:    memcpy(t104, t378, 8);
    goto LAB124;

}


extern void work_m_00000000003630610098_1615676408_init()
{
	static char *pe[] = {(void *)Cont_131_0};
	xsi_register_didat("work_m_00000000003630610098_1615676408", "isim/test1_tb_isim_beh.exe.sim/work/m_00000000003630610098_1615676408.didat");
